  ...
  return (
    <div className="styled-loader-wrapper">
      <style dangerouslySetInnerHTML={{__html: `
        ...
        .styled-loader-wrapper .pencil {
          display: block;
          width: 8em;
          height: 8em;
        }

        .styled-loader-wrapper .pencil__body1,
        .styled-loader-wrapper .pencil__body2,
        .styled-loader-wrapper .pencil__body3,
        .styled-loader-wrapper .pencil__eraser,
        .styled-loader-wrapper .pencil__eraser-skew,
        .styled-loader-wrapper .pencil__point,
        .styled-loader-wrapper .pencil__rotate,
        .styled-loader-wrapper .pencil__stroke {
