...
export const LogoLoop = React.memo<LogoLoopProps>(
  ({
    ...
    const effectiveHoverSpeed = useMemo(() => {
      ...
      if (hoverSpeed !== undefined) baseSpeed = hoverSpeed;
      else if (pauseOnHover === true) baseSpeed = 0;
      else if (pauseOnHover === false) return undefined;
      else baseSpeed = 0;
      ...
      return baseSpeed * directionMultiplier * speedMultiplier;
    }, [hoverSpeed, pauseOnHover, direction, isVertical, speed]);
